...
TOOLS="bridge-run bridge-mount bridge-umount bridge-mounts bridge-check bridge-grep bridge-git bridge-reset bridge-statusd bridge-daemon"
{
...
echo 'for p in win-run:bridge-run win-check:bridge-check win-mounts:bridge-mounts win-grep:bridge-grep win-git:bridge-git win-reset:bridge-reset win-daemon:bridge-daemon; do'
